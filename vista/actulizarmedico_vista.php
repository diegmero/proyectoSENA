					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
						...
						<select name="especialidad" required>
							...
							<?php foreach ($especialidades as $especialidad): ?>
								<option value="<?php echo htmlspecialchars($especialidad['espNombre']); ?>" 
										<?php echo ($medico['medEspecialidad'] == $especialidad['espNombre']) ? 'selected' : ''; ?>>
									<?php echo htmlspecialchars($especialidad['espNombre']); ?>
								</option>
							<?php endforeach; ?>
						</select>
