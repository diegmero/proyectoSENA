	...
	<div class="wrapp">
		...
		<article>
			...
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
				<h2>Agregar Citas</h2>
				<label>Fecha:</label>
				<input type="date" name="citfecha" value="<?php echo htmlspecialchars($cita['citfecha']); ?>" placeholder="Fecha:" required/>
				<label>Hora:</label>
				<input type="time" name="cithora" value="<?php echo htmlspecialchars($cita['cithora']); ?>" min="08:00" max="20:30"  step="60" required>
				...
				<label>Estado:</label required>
					...
					<input type="hidden" name="idcita" value="<?php echo $id_cita; ?>">
